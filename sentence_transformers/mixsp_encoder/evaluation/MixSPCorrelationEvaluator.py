...
class MixSPCorrelationEvaluator:
    """
    ...
    def __init__(self, sentence_pairs: List[List[str]], scores: List[float], name: str='', write_csv: bool = True):
        ...
        self.csv_file = "MixSPCorrelationEvaluator" + ("_" + name if name else '') + "_results.csv"
    ...
    def __call__(self, model, output_path: str = None, epoch: int = -1, steps: int = -1) -> float:
        ...
        logger.info("MixSPCorrelationEvaluator: Evaluating the model on " + self.name + " dataset" + out_txt)
